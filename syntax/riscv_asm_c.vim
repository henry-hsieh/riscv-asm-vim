...
" CL-type
if exists("b:riscv_asm_all_enable") || exists("b:riscv_asm_d") && b:riscv_asm_addr_bit <= 64
    syn keyword riscvCInstruction          c.fld
endif
if exists("b:riscv_asm_all_enable") || b:riscv_asm_addr_bit == 128
    syn keyword riscvCInstruction          c.lq
endif
syn keyword riscvCInstruction          c.lw
if exists("b:riscv_asm_all_enable") || exists("b:riscv_asm_f") && b:riscv_asm_addr_bit == 32
