...
" Ssctr Extension: Supervisor-Level Control Transfer Records
let s:riscv_asm_isa = s:add_versioned_extension(s:riscv_asm_isa, "Ssctr", 1.0, 1)
...
let s:riscv_asm_isa = s:add_versioned_extension(s:riscv_asm_isa, "Sspm", 1.0, 1)
...
" Smctr Extension: Machine-Level Control Transfer Records
let s:riscv_asm_isa = s:add_versioned_extension(s:riscv_asm_isa, "Smctr", 1.0, 1)
